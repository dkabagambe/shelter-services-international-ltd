            ...
            >
              <div className="relative">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-full border border-primary-foreground/20 bg-primary-foreground/10 pl-11 pr-5 text-sm text-primary-foreground outline-hidden transition-colors placeholder:text-primary-foreground/50 focus:border-primary-foreground/40 focus:bg-primary-foreground/15"
                />
              </div>
              <input
                type="text"
                placeholder="Company name (optional)"
                className="h-12 w-full rounded-full border border-primary-foreground/20 bg-primary-foreground/10 px-5 text-sm text-primary-foreground outline-hidden transition-colors placeholder:text-primary-foreground/50 focus:border-primary-foreground/40"
              />
              <Button type="submit" size="lg" variant="secondary" className="w-full rounded-full font-bold">
