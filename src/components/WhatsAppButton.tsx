...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 rounded-full bg-[#25d366] px-4 py-3 text-white shadow-lg transition-all hover:bg-[#1ebe5d] hover:shadow-xl hover:-translate-y-0.5"
    >
      {/* WhatsApp SVG */}
      <svg
        viewBox="0 0 24 24"
